...
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.1.png?raw=true)

![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.3.png?raw=true)
---
...
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.13.jpeg?raw=true)
...
1.  **Push the APK to the Android Device:**
    ...
    * Run the command to install the AFLogical OSE APK on the device:
        ...
        ```
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.7.png?raw=true)
...
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.12.jpeg?raw=true)

![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.11.jpeg?raw=true)
...
1.  **Use ADB to Pull Data:**
    * After extraction is complete, transfer the collected data files from the Android device to your computer using the `adb pull` command:
        ...
        ```
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.8.png?raw=true)
...
![images/exp1-disk-step1.png](https://github.com/Yaswanth767/Digital-Forensics/blob/main/images/7.9.png?raw=true)
---
